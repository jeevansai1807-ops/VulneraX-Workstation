    ...
    <div className="relative w-full h-full min-h-[80vh] flex flex-col items-center justify-center overflow-hidden">
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl px-4 mt-[-10vh]">
        <motion.h1 
          ...
          className="text-6xl md:text-8xl font-black text-foreground tracking-tighter mb-6"
        >
          See everything.
        </motion.h1>
        ...
        <motion.button 
          ...
          className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 py-4 rounded-full font-bold text-lg shadow-[0_0_40px_rgba(6,182,212,0.3)] transition-all"
        >
          Start Scan
        </motion.button>
      </div>
      ...
      <div className="absolute bottom-10 left-0 right-0 z-10 flex flex-col md:flex-row justify-center gap-6 px-6 pointer-events-none">
        <motion.div 
          ...
          className="bg-card backdrop-blur-xl border border-border rounded-3xl p-6 md:w-80 pointer-events-auto shadow-sm"
        >
          <Search className="h-6 w-6 text-foreground/80 mb-3" />
        ...
        <motion.div 
          ...
          className="bg-card backdrop-blur-xl border border-border rounded-3xl p-6 md:w-80 pointer-events-auto shadow-sm"
        >
          <Eye className="h-6 w-6 text-foreground/80 mb-3" />
