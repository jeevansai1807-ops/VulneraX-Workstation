...
REPORTS_DIR = os.path.join(_APP_DATA_DIR, "reports")
...
"""
    ...
    html += '<div class="footer"><p>Generated by VulneraX</p></div></div></body></html>'
...
def generate_pdf_report(scan_result: ScanResult) -> str:
    ...
    pdf.set_text_color(*_CLR_TEXT_MUTED)
    pdf.cell(0, 8, "Generated by VulneraX", ln=True, align="C")
